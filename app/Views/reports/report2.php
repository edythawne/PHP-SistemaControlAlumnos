            ...
            <?php  if ($i == 0): ?>
                ...
                <div style="page-break-after: always; font-size: 20px;">
                    ...
                    <table style="">
                        <thead>
                        <tr bgcolor="#c3c3c3">
                            <th colspan="4">ALUMNOS <?php echo $html['students'][$i]['grado'].'° '.$html['students'][$i]['grupo']; ?></th>
                        </tr>
                        <tr bgcolor="#c3c3c3">
                            <th>NÚMERO</th>
                        ...
                        <tr>
                            ...
                            <td><?php echo $html['students'][$i]['ape_paterno'] ?></td>
                            <td><?php echo $html['students'][$i]['ape_materno'] ?></td>
                            <td><?php echo $html['students'][$i]['nombre']; ?></td>
                        </tr>
            <?php else: ?>
